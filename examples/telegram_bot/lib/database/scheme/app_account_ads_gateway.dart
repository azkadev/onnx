...
part "app_account_ads_gateway.g.dart";

@collection
class AppAccountAdsGateway {
  ...
  static Map get defaultData {
    return {"id": 0, "created_at": "", "date": 0, "meesagee_user_id": 0};
  }
  ...
  static AppAccountAdsGateway create({
    ...
    AppAccountAdsGateway appAccountAdsGateway_data_create =
        AppAccountAdsGateway();

    if (utils_is_print_data) {
      // print(appAccountAdsGateway_data_create.toStringPretty());
    }
