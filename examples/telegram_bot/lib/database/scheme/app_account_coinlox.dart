...
part "app_account_coinlox.g.dart";

@collection
class AppAccountCoinlox {
  ...
  static AppAccountCoinlox create({
    ...
    AppAccountCoinlox appAccountCoinlox_data_create = AppAccountCoinlox();

    if (utils_is_print_data) {
      // print(appAccountCoinlox_data_create.toStringPretty());
    }
