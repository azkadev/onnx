...
part "app_account_envivore.g.dart";

@collection
class AppAccountEnvivore {
  ...
  static AppAccountEnvivore create({
    ...
    AppAccountEnvivore appAccountEnvivore_data_create = AppAccountEnvivore();

    if (utils_is_print_data) {
      // print(appAccountEnvivore_data_create.toStringPretty());
    }
