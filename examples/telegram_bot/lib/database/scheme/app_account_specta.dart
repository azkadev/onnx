...
part "app_account_specta.g.dart";

@collection
class AppAccountSpecta {
  ...
  static AppAccountSpecta create({
    ...
    AppAccountSpecta appAccountSpecta_data_create = AppAccountSpecta();

    if (utils_is_print_data) {
      // print(appAccountSpecta_data_create.toStringPretty());
    }
