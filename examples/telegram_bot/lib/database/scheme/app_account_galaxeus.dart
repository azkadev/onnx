...
part "app_account_galaxeus.g.dart";

@collection
class AppAccountGalaxeus {
  ...
  static AppAccountGalaxeus create({
    ...
    AppAccountGalaxeus appAccountGalaxeus_data_create = AppAccountGalaxeus();

    if (utils_is_print_data) {
      // print(appAccountGalaxeus_data_create.toStringPretty());
    }
