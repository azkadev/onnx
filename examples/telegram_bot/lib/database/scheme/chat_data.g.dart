...
void _chatDataSerialize(
  ...
  writer.writeLong(offsets[3], object.room_chat_id);
}
...
ChatData _chatDataDeserialize(
  ...
  object.id = id;
  object.room_chat_id = reader.readLong(offsets[3]);
  return object;
}
...
extension ChatDataQueryFilter
  ...
  QueryBuilder<ChatData, ChatData, QAfterFilterCondition> room_chat_idEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<ChatData, ChatData, QAfterFilterCondition> room_chat_idLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ChatData, ChatData, QAfterFilterCondition> room_chat_idBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ChatDataQuerySortBy on QueryBuilder<ChatData, ChatData, QSortBy> {
  ...
  QueryBuilder<ChatData, ChatData, QAfterSortBy> sortByRoom_chat_id() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'room_chat_id', Sort.asc);
    });
  }

  QueryBuilder<ChatData, ChatData, QAfterSortBy> sortByRoom_chat_idDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ChatDataQuerySortThenBy
  ...
  QueryBuilder<ChatData, ChatData, QAfterSortBy> thenByRoom_chat_id() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'room_chat_id', Sort.asc);
    });
  }

  QueryBuilder<ChatData, ChatData, QAfterSortBy> thenByRoom_chat_idDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'room_chat_id', Sort.desc);
    });
  }
...
extension ChatDataQueryWhereDistinct
  ...
  QueryBuilder<ChatData, ChatData, QDistinct> distinctByRoom_chat_id() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'room_chat_id');
    });
  }
}
...
extension ChatDataQueryProperty
  ...
  QueryBuilder<ChatData, int, QQueryOperations> room_chat_idProperty() {
    return QueryBuilder.apply(this, (query) {
