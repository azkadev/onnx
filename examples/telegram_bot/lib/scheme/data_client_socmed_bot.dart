...
class DataClientSocmedBot extends JsonScheme {
  DataClientSocmedBot(super.rawData);

  static Map get defaultData {
    return {
      "@type": "dataClientSocmedBot",
      "bot_user_id": 0,
      "owner_user_id": 0,
      "date": 0,
      "expire_date": 0,
  ...
  static DataClientSocmedBot create({
    String special_type = "dataClientSocmedBot",
    int? bot_user_id,
    int? owner_user_id,
    int? date,
    int? expire_date,
    ...
    // DataClientSocmedBot dataClientSocmedBot = DataClientSocmedBot({
    Map dataClientSocmedBot_data_create_json = {
      "@type": special_type,
    ...
    dataClientSocmedBot_data_create_json
        .removeWhere((key, value) => value == null);
    DataClientSocmedBot dataClientSocmedBot_data_create =
        DataClientSocmedBot(dataClientSocmedBot_data_create_json);

    return dataClientSocmedBot_data_create;
  }
}
