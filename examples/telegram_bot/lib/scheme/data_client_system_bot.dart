...
class DataClientSystemBot extends JsonScheme {
  DataClientSystemBot(super.rawData);

  static Map get defaultData {
    return {
      "@type": "dataClientSystemBot",
      "user_id": 0,
      "owner_user_id": 0,
      "date": 0,
      "expire_date": 0,
  ...
  static DataClientSystemBot create({
    String special_type = "dataClientSystemBot",
    int? user_id,
    int? owner_user_id,
    int? date,
    int? expire_date,
    ...
    // DataClientSystemBot dataClientSystemBot = DataClientSystemBot({
    Map dataClientSystemBot_data_create_json = {
      "@type": special_type,
      "user_id": user_id,
    ...
    dataClientSystemBot_data_create_json
        .removeWhere((key, value) => value == null);
    DataClientSystemBot dataClientSystemBot_data_create =
        DataClientSystemBot(dataClientSystemBot_data_create_json);

    return dataClientSystemBot_data_create;
  }
}
