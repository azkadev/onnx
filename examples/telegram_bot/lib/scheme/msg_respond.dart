...
class MsgRespond extends JsonScheme {
  MsgRespond(super.rawData);
  ...
  static MsgRespond create({
    String special_type = "msg_respond",
    int? date,
    ...
    // MsgRespond msgRespond = MsgRespond({
    Map msgRespond_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    msgRespond_data_create_json.removeWhere((key, value) => value == null);
    MsgRespond msgRespond_data_create = MsgRespond(msgRespond_data_create_json);

    return msgRespond_data_create;
  }
}
