...
class DataClientAiBot extends JsonScheme {
  DataClientAiBot(super.rawData);

  static Map get defaultData {
    return {
      "@type": "dataClientAiBot",
      "bot_user_id": 0,
      "owner_user_id": 0,
      "date": 0,
      "expire_date": 0,
  ...
  static DataClientAiBot create({
    String special_type = "dataClientAiBot",
    int? bot_user_id,
    int? owner_user_id,
    int? date,
    int? expire_date,
    ...
    // DataClientAiBot dataClientAiBot = DataClientAiBot({
    Map dataClientAiBot_data_create_json = {
      "@type": special_type,
    ...
    dataClientAiBot_data_create_json.removeWhere((key, value) => value == null);
    DataClientAiBot dataClientAiBot_data_create =
        DataClientAiBot(dataClientAiBot_data_create_json);

    return dataClientAiBot_data_create;
  }
}
