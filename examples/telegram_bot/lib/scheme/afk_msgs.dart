...
class AfkMsgs extends JsonScheme {
  AfkMsgs(super.rawData);
  ...
  static AfkMsgs create({
    ...
    String special_type = "afk_msgs",
  }) {
    // AfkMsgs afkMsgs = AfkMsgs({
    Map afkMsgs_data_create_json = {
      "date": date,
    ...
    afkMsgs_data_create_json.removeWhere((key, value) => value == null);
    AfkMsgs afkMsgs_data_create = AfkMsgs(afkMsgs_data_create_json);

    return afkMsgs_data_create;
  }
}
