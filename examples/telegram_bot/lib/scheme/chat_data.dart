...
import "chats.dart";
import "auto_forward_review_msg.dart";
import "auto_forward_review_keyboard.dart";
import "auto_forward_limit_msg.dart";
import "auto_forward_limit_keyboard.dart";
import "force_subscribe_bot.dart";
...
class ChatData extends JsonScheme {
  ...
  static Map get defaultData {
    return {
      ...
      "plan_type": "free",
      "is_bot": true,
      "is_force_terms": false,
      "terms_of_services": "",
      "policy_and_privacy": "",
      "dynamic_accept_terms": false,
      "timer_msg_free": "",
      "count_msg_free": 0,
      "timer_msg_regular": "",
      "count_msg_regular": 0,
      ...
      "timer_msg_ultra": "",
      "count_msg_ultra": 0,
      "dynamic_is_timer_msg_send": false,
      "dynamic_timer_msg_id": 0,
      "dynamic_count_msg": 0,
      "dynamic_msg_expire_date": 0,
      "is_auto_read": true,
      "is_auto_clear": true,
      "is_auto_block": false,
      "is_afk": false,
      ...
      "dynamic_telegram_login_widget_cookie": "",
      "is_ads_gateway": false,
      "ads_gateway_is_require_review": false,
      "ads_gateway_type_content": ["text"],
      "ads_gateway_msg_count": 10,
      "ads_gateway_chat_types": ["group", "private", "channel"],
      "dynamic_start_command": "",
      "dynamic_ads_gateway_count": 0,
      "is_subscribe": false,
      ...
      "count_send_msg": 0,
      "auto_forward_plan_need_reviews": ["free"],
      "auto_forward_review_msg": {
        "@type": "auto_forward_review_msg",
        "date": 1688753865,
        "can_reply_to_message_id": false,
        "can_disable_web_page_preview": false,
        "can_allow_sending_without_reply": true,
      ...
      "auto_forward_limit_msg": {
        "@type": "auto_forward_limit_msg",
        "date": 1688753865,
        "can_reply_to_message_id": false,
        "can_disable_web_page_preview": false,
        "can_allow_sending_without_reply": true,
      ...
      "auto_forward_timer_free": "0-0-0-0-0-0",
      "auto_forward_timer_regular": "0-0-0-0-0-0",
      "auto_forward_timer_premium": "0-0-0-0-0-0",
      "auto_forward_timer_ultra": "0-0-0-0-0-0",
      "dynamic_auto_forward_timer_expire_date": 0,
      "auto_forward_price": 0,
      "auto_forward_price_with_pinned": 10,
      "auto_forward_price_with_close": 10,
      "text_payment": "",
      "coin": 0,
      "is_secret_data": false,
      "is_secret_data_user": false,
      "is_force_subscribe": false,
      "force_subscribe_mode": "direct",
      "force_subscribe_bot": {
  ...
  bool? get is_force_terms {
    try {
      if (rawData["is_force_terms"] is bool == false) {
        return null;
      }
      return rawData["is_force_terms"] as bool;
    } catch (e) {
      return null;
    }
  }
  ...
  String? get terms_of_services {
    try {
      if (rawData["terms_of_services"] is String == false) {
        return null;
      }
      return rawData["terms_of_services"] as String;
    } catch (e) {
      return null;
    }
  }

  String? get policy_and_privacy {
    try {
      if (rawData["policy_and_privacy"] is String == false) {
        return null;
      }
      return rawData["policy_and_privacy"] as String;
    } catch (e) {
      return null;
    }
  }

  bool? get dynamic_accept_terms {
    try {
      if (rawData["dynamic_accept_terms"] is bool == false) {
        return null;
      }
      return rawData["dynamic_accept_terms"] as bool;
    } catch (e) {
      return null;
    }
  }

  String? get timer_msg_free {
    try {
      if (rawData["timer_msg_free"] is String == false) {
        return null;
      }
      return rawData["timer_msg_free"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get count_msg_free {
    try {
      if (rawData["count_msg_free"] is int == false) {
        return null;
      }
      return rawData["count_msg_free"] as int;
    } catch (e) {
      return null;
    }
  }

  String? get timer_msg_regular {
    try {
      if (rawData["timer_msg_regular"] is String == false) {
        return null;
      }
      return rawData["timer_msg_regular"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get count_msg_regular {
    try {
      if (rawData["count_msg_regular"] is int == false) {
        return null;
      }
      return rawData["count_msg_regular"] as int;
    } catch (e) {
      return null;
    }
  }

  String? get timer_msg_premium {
    try {
      if (rawData["timer_msg_premium"] is String == false) {
        return null;
      }
      return rawData["timer_msg_premium"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get count_msg_premium {
    try {
      if (rawData["count_msg_premium"] is int == false) {
        return null;
      }
      return rawData["count_msg_premium"] as int;
    } catch (e) {
      return null;
    }
  }

  String? get timer_msg_ultra {
    try {
      if (rawData["timer_msg_ultra"] is String == false) {
        return null;
      }
      return rawData["timer_msg_ultra"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get count_msg_ultra {
    try {
      if (rawData["count_msg_ultra"] is int == false) {
        return null;
      }
      return rawData["count_msg_ultra"] as int;
    } catch (e) {
      return null;
    }
  }

  bool? get dynamic_is_timer_msg_send {
    try {
      if (rawData["dynamic_is_timer_msg_send"] is bool == false) {
        return null;
      }
      return rawData["dynamic_is_timer_msg_send"] as bool;
    } catch (e) {
      return null;
    }
  }

  int? get dynamic_timer_msg_id {
    try {
      if (rawData["dynamic_timer_msg_id"] is int == false) {
        return null;
      }
      return rawData["dynamic_timer_msg_id"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get dynamic_count_msg {
    try {
      if (rawData["dynamic_count_msg"] is int == false) {
        return null;
      }
      return rawData["dynamic_count_msg"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get dynamic_msg_expire_date {
    try {
      if (rawData["dynamic_msg_expire_date"] is int == false) {
        return null;
      }
      return rawData["dynamic_msg_expire_date"] as int;
    } catch (e) {
      return null;
    }
  }
  ...
  String? get dynamic_telegram_login_widget_cookie {
    try {
      if (rawData["dynamic_telegram_login_widget_cookie"] is String == false) {
        return null;
      }
      return rawData["dynamic_telegram_login_widget_cookie"] as String;
    } catch (e) {
      return null;
    }
  }
  ...
  int? get ads_gateway_msg_count {
    try {
      if (rawData["ads_gateway_msg_count"] is int == false) {
        return null;
      }
      return rawData["ads_gateway_msg_count"] as int;
    } catch (e) {
      return null;
    }
  }

  List<String> get ads_gateway_chat_types {
    try {
      if (rawData["ads_gateway_chat_types"] is List == false) {
        return [];
      }
      return (rawData["ads_gateway_chat_types"] as List).cast<String>();
    } catch (e) {
      return [];
    }
  }

  String? get dynamic_start_command {
    try {
      if (rawData["dynamic_start_command"] is String == false) {
        return null;
      }
      return rawData["dynamic_start_command"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get dynamic_ads_gateway_count {
    try {
      if (rawData["dynamic_ads_gateway_count"] is int == false) {
        return null;
      }
      return rawData["dynamic_ads_gateway_count"] as int;
    } catch (e) {
      return null;
    }
  }
  ...
  int? get price_regular {
    try {
      if (rawData["price_regular"] is int == false) {
        return null;
      }
      return rawData["price_regular"] as int;
    } catch (e) {
      return null;
    }
  }
  ...
  int? get price_ultra {
    try {
      if (rawData["price_ultra"] is int == false) {
        return null;
      }
      return rawData["price_ultra"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get quota_premium_app {
    try {
      if (rawData["quota_premium_app"] is int == false) {
        return null;
      }
      return rawData["quota_premium_app"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get quota_nonpremium_app {
    try {
      if (rawData["quota_nonpremium_app"] is int == false) {
        return null;
      }
      return rawData["quota_nonpremium_app"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get price_premium_app {
    try {
      if (rawData["price_premium_app"] is int == false) {
        return null;
      }
      return rawData["price_premium_app"] as int;
    } catch (e) {
      return null;
    }
  }
  ...
  List<String> get auto_forward_plan_need_reviews {
    try {
      if (rawData["auto_forward_plan_need_reviews"] is List == false) {
        return [];
      }
      return (rawData["auto_forward_plan_need_reviews"] as List).cast<String>();
    } catch (e) {
      return [];
    }
  }

  AutoForwardReviewMsg get auto_forward_review_msg {
    try {
      if (rawData["auto_forward_review_msg"] is Map == false) {
        return AutoForwardReviewMsg({});
      }
      return AutoForwardReviewMsg(rawData["auto_forward_review_msg"] as Map);
    } catch (e) {
      return AutoForwardReviewMsg({});
    }
  }

  AutoForwardReviewKeyboard get auto_forward_review_keyboard {
    try {
      if (rawData["auto_forward_review_keyboard"] is Map == false) {
        return AutoForwardReviewKeyboard({});
      }
      return AutoForwardReviewKeyboard(
          rawData["auto_forward_review_keyboard"] as Map);
    } catch (e) {
      return AutoForwardReviewKeyboard({});
    }
  }

  AutoForwardLimitMsg get auto_forward_limit_msg {
    try {
      if (rawData["auto_forward_limit_msg"] is Map == false) {
        return AutoForwardLimitMsg({});
      }
      return AutoForwardLimitMsg(rawData["auto_forward_limit_msg"] as Map);
    } catch (e) {
      return AutoForwardLimitMsg({});
    }
  }

  AutoForwardLimitKeyboard get auto_forward_limit_keyboard {
    try {
      if (rawData["auto_forward_limit_keyboard"] is Map == false) {
        return AutoForwardLimitKeyboard({});
      }
      return AutoForwardLimitKeyboard(
          rawData["auto_forward_limit_keyboard"] as Map);
    } catch (e) {
      return AutoForwardLimitKeyboard({});
    }
  }
  ...
  String? get auto_forward_timer_free {
    try {
      if (rawData["auto_forward_timer_free"] is String == false) {
        return null;
      }
      return rawData["auto_forward_timer_free"] as String;
    } catch (e) {
      return null;
    }
  }

  String? get auto_forward_timer_regular {
    try {
      if (rawData["auto_forward_timer_regular"] is String == false) {
        return null;
      }
      return rawData["auto_forward_timer_regular"] as String;
    } catch (e) {
      return null;
    }
  }

  String? get auto_forward_timer_premium {
    try {
      if (rawData["auto_forward_timer_premium"] is String == false) {
        return null;
      }
      return rawData["auto_forward_timer_premium"] as String;
    } catch (e) {
      return null;
    }
  }

  String? get auto_forward_timer_ultra {
    try {
      if (rawData["auto_forward_timer_ultra"] is String == false) {
        return null;
      }
      return rawData["auto_forward_timer_ultra"] as String;
    } catch (e) {
      return null;
    }
  }

  int? get dynamic_auto_forward_timer_expire_date {
    try {
      if (rawData["dynamic_auto_forward_timer_expire_date"] is int == false) {
        return null;
      }
      return rawData["dynamic_auto_forward_timer_expire_date"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get auto_forward_price {
    try {
      if (rawData["auto_forward_price"] is int == false) {
        return null;
      }
      return rawData["auto_forward_price"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get auto_forward_price_with_pinned {
    try {
      if (rawData["auto_forward_price_with_pinned"] is int == false) {
        return null;
      }
      return rawData["auto_forward_price_with_pinned"] as int;
    } catch (e) {
      return null;
    }
  }

  int? get auto_forward_price_with_close {
    try {
      if (rawData["auto_forward_price_with_close"] is int == false) {
        return null;
      }
      return rawData["auto_forward_price_with_close"] as int;
    } catch (e) {
      return null;
    }
  }
  ...
  String? get force_subscribe_mode {
    try {
      if (rawData["force_subscribe_mode"] is String == false) {
        return null;
      }
      return rawData["force_subscribe_mode"] as String;
    } catch (e) {
      return null;
    }
  }

  ForceSubscribeBot get force_subscribe_bot {
    try {
      if (rawData["force_subscribe_bot"] is Map == false) {
        return ForceSubscribeBot({});
      }
      return ForceSubscribeBot(rawData["force_subscribe_bot"] as Map);
    } catch (e) {
      return ForceSubscribeBot({});
    }
  }
  ...
  static ChatData create({
    ...
    bool? is_bot,
    bool? is_force_terms,
    String? terms_of_services,
    String? policy_and_privacy,
    bool? dynamic_accept_terms,
    String? timer_msg_free,
    int? count_msg_free,
    String? timer_msg_regular,
    int? count_msg_regular,
    String? timer_msg_premium,
    int? count_msg_premium,
    String? timer_msg_ultra,
    int? count_msg_ultra,
    bool? dynamic_is_timer_msg_send,
    int? dynamic_timer_msg_id,
    int? dynamic_count_msg,
    int? dynamic_msg_expire_date,
    bool? is_auto_read,
    bool? is_auto_clear,
    bool? is_auto_block,
    bool? is_afk,
    ...
    String? dynamic_telegram_login_widget_cookie,
    bool? is_ads_gateway,
    bool? ads_gateway_is_require_review,
    List<String>? ads_gateway_type_content,
    int? ads_gateway_msg_count,
    List<String>? ads_gateway_chat_types,
    String? dynamic_start_command,
    int? dynamic_ads_gateway_count,
    bool? is_subscribe,
    ...
    int? price_premium,
    int? price_ultra,
    int? quota_premium_app,
    int? quota_nonpremium_app,
    int? price_premium_app,
    ...
    int? count_send_msg,
    List<String>? auto_forward_plan_need_reviews,
    AutoForwardReviewMsg? auto_forward_review_msg,
    AutoForwardReviewKeyboard? auto_forward_review_keyboard,
    AutoForwardLimitMsg? auto_forward_limit_msg,
    AutoForwardLimitKeyboard? auto_forward_limit_keyboard,
    int? reset_auto_forward_limit_date,
    String? auto_forward_timer_free,
    String? auto_forward_timer_regular,
    String? auto_forward_timer_premium,
    String? auto_forward_timer_ultra,
    int? dynamic_auto_forward_timer_expire_date,
    int? auto_forward_price,
    int? auto_forward_price_with_pinned,
    int? auto_forward_price_with_close,
    String? text_payment,
    int? coin,
    bool? is_secret_data,
    bool? is_secret_data_user,
    bool? is_force_subscribe,
    String? force_subscribe_mode,
    ForceSubscribeBot? force_subscribe_bot,
    ...
    Map chatData_data_create_json = {
      ...
      "plan_type": plan_type,
      "is_bot": is_bot,
      "is_force_terms": is_force_terms,
      "terms_of_services": terms_of_services,
      "policy_and_privacy": policy_and_privacy,
      "dynamic_accept_terms": dynamic_accept_terms,
      "timer_msg_free": timer_msg_free,
      "count_msg_free": count_msg_free,
      "timer_msg_regular": timer_msg_regular,
      "count_msg_regular": count_msg_regular,
      "timer_msg_premium": timer_msg_premium,
      "count_msg_premium": count_msg_premium,
      "timer_msg_ultra": timer_msg_ultra,
      "count_msg_ultra": count_msg_ultra,
      "dynamic_is_timer_msg_send": dynamic_is_timer_msg_send,
      "dynamic_timer_msg_id": dynamic_timer_msg_id,
      "dynamic_count_msg": dynamic_count_msg,
      "dynamic_msg_expire_date": dynamic_msg_expire_date,
      ...
      "ads_gateway_msg_count": ads_gateway_msg_count,
      "ads_gateway_chat_types": ads_gateway_chat_types,
      "dynamic_start_command": dynamic_start_command,
      "dynamic_ads_gateway_count": dynamic_ads_gateway_count,
      ...
      "quota_premium_app": quota_premium_app,
      "quota_nonpremium_app": quota_nonpremium_app,
      "price_premium_app": price_premium_app,
      ...
      "auto_forward_plan_need_reviews": auto_forward_plan_need_reviews,
      "auto_forward_review_msg": (auto_forward_review_msg != null)
          ? auto_forward_review_msg.toJson()
          : null,
      "auto_forward_review_keyboard": (auto_forward_review_keyboard != null)
          ? auto_forward_review_keyboard.toJson()
          : null,
      "auto_forward_limit_msg": (auto_forward_limit_msg != null)
          ? auto_forward_limit_msg.toJson()
          : null,
      "auto_forward_limit_keyboard": (auto_forward_limit_keyboard != null)
          ? auto_forward_limit_keyboard.toJson()
          : null,
      "reset_auto_forward_limit_date": reset_auto_forward_limit_date,
      "auto_forward_timer_free": auto_forward_timer_free,
      "auto_forward_timer_regular": auto_forward_timer_regular,
      "auto_forward_timer_premium": auto_forward_timer_premium,
      "auto_forward_timer_ultra": auto_forward_timer_ultra,
      "dynamic_auto_forward_timer_expire_date":
          dynamic_auto_forward_timer_expire_date,
      "auto_forward_price": auto_forward_price,
      "auto_forward_price_with_pinned": auto_forward_price_with_pinned,
      "auto_forward_price_with_close": auto_forward_price_with_close,
      ...
      "force_subscribe_mode": force_subscribe_mode,
      "force_subscribe_bot":
          (force_subscribe_bot != null) ? force_subscribe_bot.toJson() : null,
