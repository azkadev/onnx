...
class AccesMsgData extends JsonScheme {
  AccesMsgData(super.rawData);
  ...
  static AccesMsgData create({
    String special_type = "accesMsgData",
    int? date,
    ...
    // AccesMsgData accesMsgData = AccesMsgData({
    Map accesMsgData_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    accesMsgData_data_create_json.removeWhere((key, value) => value == null);
    AccesMsgData accesMsgData_data_create =
        AccesMsgData(accesMsgData_data_create_json);

    return accesMsgData_data_create;
  }
}
