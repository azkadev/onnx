...
class MustHaveContentMsgRespond extends JsonScheme {
  MustHaveContentMsgRespond(super.rawData);
  ...
  static MustHaveContentMsgRespond create({
    String special_type = "must_have_content_msg_respond",
    int? date,
    ...
    // MustHaveContentMsgRespond mustHaveContentMsgRespond = MustHaveContentMsgRespond({
    Map mustHaveContentMsgRespond_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    mustHaveContentMsgRespond_data_create_json
        .removeWhere((key, value) => value == null);
    MustHaveContentMsgRespond mustHaveContentMsgRespond_data_create =
        MustHaveContentMsgRespond(mustHaveContentMsgRespond_data_create_json);

    return mustHaveContentMsgRespond_data_create;
  }
}
