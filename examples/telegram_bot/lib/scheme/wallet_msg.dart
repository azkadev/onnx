...
class WalletMsg extends JsonScheme {
  WalletMsg(super.rawData);
  ...
  static WalletMsg create({
    String special_type = "wallet_msg",
    int? date,
    ...
    // WalletMsg walletMsg = WalletMsg({
    Map walletMsg_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    walletMsg_data_create_json.removeWhere((key, value) => value == null);
    WalletMsg walletMsg_data_create = WalletMsg(walletMsg_data_create_json);

    return walletMsg_data_create;
  }
}
