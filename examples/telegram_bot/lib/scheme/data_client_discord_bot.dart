...
class DataClientDiscordBot extends JsonScheme {
  DataClientDiscordBot(super.rawData);

  static Map get defaultData {
    return {
      "@type": "dataClientDiscordBot",
      "bot_user_id": 0,
      "owner_user_id": 0,
      "date": 0,
      "expire_date": 0,
  ...
  static DataClientDiscordBot create({
    String special_type = "dataClientDiscordBot",
    int? bot_user_id,
    int? owner_user_id,
    int? date,
    int? expire_date,
    ...
    // DataClientDiscordBot dataClientDiscordBot = DataClientDiscordBot({
    Map dataClientDiscordBot_data_create_json = {
      "@type": special_type,
    ...
    dataClientDiscordBot_data_create_json
        .removeWhere((key, value) => value == null);
    DataClientDiscordBot dataClientDiscordBot_data_create =
        DataClientDiscordBot(dataClientDiscordBot_data_create_json);

    return dataClientDiscordBot_data_create;
  }
}
