...
class LastName extends JsonScheme {
  LastName(super.rawData);
  ...
  static LastName create({
    String special_type = "last_name",
    String? empty,
    String? not_empty,
    String? whitelist,
    String? blacklist,
    ...
    lastName_data_create_json.removeWhere((key, value) => value == null);
    LastName lastName_data_create = LastName(lastName_data_create_json);

    return lastName_data_create;
  }
}
