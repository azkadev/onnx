...
class Respond extends JsonScheme {
  Respond(super.rawData);
  ...
  static Respond create({
    String special_type = "respond",
    int? date,
    ...
    respond_data_create_json.removeWhere((key, value) => value == null);
    Respond respond_data_create = Respond(respond_data_create_json);

    return respond_data_create;
  }
}
