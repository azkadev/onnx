...
class AppAccountEnvivore extends JsonScheme {
  AppAccountEnvivore(super.rawData);

  static Map get defaultData {
    return {
      "@type": "appAccountEnvivore",
      "isar_data_id": 0,
      "id": 0,
      "created_at": "",
      "date": 0,
  ...
  static AppAccountEnvivore create({
    String special_type = "appAccountEnvivore",
    int? isar_data_id,
    int? id,
    String? created_at,
    int? date,
    ...
    // AppAccountEnvivore appAccountEnvivore = AppAccountEnvivore({
    Map appAccountEnvivore_data_create_json = {
      "@type": special_type,
    ...
    appAccountEnvivore_data_create_json
        .removeWhere((key, value) => value == null);
    AppAccountEnvivore appAccountEnvivore_data_create =
        AppAccountEnvivore(appAccountEnvivore_data_create_json);

    return appAccountEnvivore_data_create;
  }
}
