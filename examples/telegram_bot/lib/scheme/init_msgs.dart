...
class InitMsgs extends JsonScheme {
  InitMsgs(super.rawData);
  ...
  static InitMsgs create({
    ...
    String special_type = "init_msgs",
  }) {
    // InitMsgs initMsgs = InitMsgs({
    Map initMsgs_data_create_json = {
      "date": date,
    ...
    initMsgs_data_create_json.removeWhere((key, value) => value == null);
    InitMsgs initMsgs_data_create = InitMsgs(initMsgs_data_create_json);

    return initMsgs_data_create;
  }
}
