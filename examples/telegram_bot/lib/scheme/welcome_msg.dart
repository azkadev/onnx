...
class WelcomeMsg extends JsonScheme {
  WelcomeMsg(super.rawData);
  ...
  static WelcomeMsg create({
    String special_type = "welcome_msg",
    int? date,
    ...
    Map welcomeMsg_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    welcomeMsg_data_create_json.removeWhere((key, value) => value == null);
    WelcomeMsg welcomeMsg_data_create = WelcomeMsg(welcomeMsg_data_create_json);

    return welcomeMsg_data_create;
  }
}
