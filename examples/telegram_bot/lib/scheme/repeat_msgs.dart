...
class RepeatMsgs extends JsonScheme {
  RepeatMsgs(super.rawData);
  ...
  static RepeatMsgs create({
    ...
    String special_type = "repeat_msgs",
  }) {
    // RepeatMsgs repeatMsgs = RepeatMsgs({
    Map repeatMsgs_data_create_json = {
      "date": date,
    ...
    repeatMsgs_data_create_json.removeWhere((key, value) => value == null);
    RepeatMsgs repeatMsgs_data_create = RepeatMsgs(repeatMsgs_data_create_json);

    return repeatMsgs_data_create;
  }
}
