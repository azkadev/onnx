...
class Responds extends JsonScheme {
  Responds(super.rawData);
  ...
  static Responds create({
    ...
    String special_type = "responds",
  }) {
    // Responds responds = Responds({
    Map responds_data_create_json = {
      "date": date,
    ...
    responds_data_create_json.removeWhere((key, value) => value == null);
    Responds responds_data_create = Responds(responds_data_create_json);

    return responds_data_create;
  }
}
