...
class AppAccountSpecta extends JsonScheme {
  AppAccountSpecta(super.rawData);

  static Map get defaultData {
    return {
      "@type": "appAccountSpecta",
      "isar_data_id": 0,
      "id": 0,
      "created_at": "",
      "date": 0,
  ...
  static AppAccountSpecta create({
    String special_type = "appAccountSpecta",
    int? isar_data_id,
    int? id,
    String? created_at,
    int? date,
    ...
    // AppAccountSpecta appAccountSpecta = AppAccountSpecta({
    Map appAccountSpecta_data_create_json = {
      "@type": special_type,
    ...
    appAccountSpecta_data_create_json
        .removeWhere((key, value) => value == null);
    AppAccountSpecta appAccountSpecta_data_create =
        AppAccountSpecta(appAccountSpecta_data_create_json);

    return appAccountSpecta_data_create;
  }
}
