...
class StartMsg extends JsonScheme {
  StartMsg(super.rawData);
  ...
  static StartMsg create({
    String special_type = "start_msg",
    int? date,
    ...
    startMsg_data_create_json.removeWhere((key, value) => value == null);
    StartMsg startMsg_data_create = StartMsg(startMsg_data_create_json);

    return startMsg_data_create;
  }
}
