...
class AutoForwardReviewMsg extends JsonScheme {
  AutoForwardReviewMsg(super.rawData);
  ...
  static AutoForwardReviewMsg create({
    String special_type = "auto_forward_review_msg",
    int? date,
    ...
    // AutoForwardReviewMsg autoForwardReviewMsg = AutoForwardReviewMsg({
    Map autoForwardReviewMsg_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    autoForwardReviewMsg_data_create_json
        .removeWhere((key, value) => value == null);
    AutoForwardReviewMsg autoForwardReviewMsg_data_create =
        AutoForwardReviewMsg(autoForwardReviewMsg_data_create_json);

    return autoForwardReviewMsg_data_create;
  }
}
