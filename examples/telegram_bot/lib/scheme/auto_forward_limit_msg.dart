...
class AutoForwardLimitMsg extends JsonScheme {
  AutoForwardLimitMsg(super.rawData);
  ...
  static AutoForwardLimitMsg create({
    String special_type = "auto_forward_limit_msg",
    int? date,
    ...
    // AutoForwardLimitMsg autoForwardLimitMsg = AutoForwardLimitMsg({
    Map autoForwardLimitMsg_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    autoForwardLimitMsg_data_create_json
        .removeWhere((key, value) => value == null);
    AutoForwardLimitMsg autoForwardLimitMsg_data_create =
        AutoForwardLimitMsg(autoForwardLimitMsg_data_create_json);

    return autoForwardLimitMsg_data_create;
  }
}
