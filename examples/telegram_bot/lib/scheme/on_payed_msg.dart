...
class OnPayedMsg extends JsonScheme {
  OnPayedMsg(super.rawData);
  ...
  static OnPayedMsg create({
    String special_type = "on_payed_msg",
    int? date,
    ...
    // OnPayedMsg onPayedMsg = OnPayedMsg({
    Map onPayedMsg_data_create_json = {
      "@type": special_type,
      "date": date,
    ...
    onPayedMsg_data_create_json.removeWhere((key, value) => value == null);
    OnPayedMsg onPayedMsg_data_create = OnPayedMsg(onPayedMsg_data_create_json);

    return onPayedMsg_data_create;
  }
}
