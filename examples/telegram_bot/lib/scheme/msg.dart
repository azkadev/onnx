...
class Msg extends JsonScheme {
  ...
  static Msg create({
    ...
    msg_data_create_json.removeWhere((key, value) => value == null);
    Msg msg_data_create = Msg(msg_data_create_json);

    return msg_data_create;
  }
}
