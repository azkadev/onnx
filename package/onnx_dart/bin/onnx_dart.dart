...
void main(List<String> args_raw) async {
  Future<Directory?> getPackageDirectory({
    String package_name =
        "package:onnx_dart/onnx_dart.dart",
  }) async {
  ...
  String name_exe = "onnx_dart";
  String help_msg = """
A command-line onnx_dart.
...
Global options:
  ...
  reload               Reload package onnx_dart.dart
...
""";
  ...
  if (command == "version") {
    print(
        "onnx_dart version: 0.0.0 (stable) on ${Platform.operatingSystem}");
    exit(0);
  }
